...
const NavBar = () => {
  ...
  return (
    <div>
      <div className="navbar font-extrabold text-3xl bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-white fixed top-0 z-50">
        {/* Navbar Start */}
        <div className="navbar-start">
          {/* Mobile Menu */}
          <div className="dropdown lg:hidden">
            ...
            >
              ...
              <li>
                <Link to="/sellerReq">Request for Seller</Link>
              </li>
              <li>
        ...
        <div className="navbar-end flex items-center space-x-3">
          {user ? (
            ...
            <Link to="/login" className="btn btn-primary text-white hover:bg-yellow-400">
              Login
            </Link>
          )}
        </div>
